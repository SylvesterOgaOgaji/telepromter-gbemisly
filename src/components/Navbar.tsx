    ...
    <header className="border-b border-debzane-blue-900/60 bg-[#030914]/95 backdrop-blur-md sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-16 sm:h-18 py-2 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          {/* Studio Video Record Button */}
          <button
            onClick={onOpenStudio}
            className="flex items-center gap-1.5 px-2.5 sm:px-3.5 py-1.5 text-xs font-black text-white bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 rounded-xl shadow-md shadow-red-600/30 transition-all transform active:scale-95 border border-red-400/30"
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-1 px-2.5 py-1.5 text-xs font-bold text-slate-200 bg-slate-900 hover:bg-slate-800 border border-slate-700/60 rounded-xl transition-all"
          >
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 sm:px-3 py-1.5 text-xs font-black text-slate-950 bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 rounded-xl shadow-md shadow-amber-500/20 transition-all transform active:scale-95"
            title="Donate via OPay"
          >
          ...
          <button
            onClick={handleShare}
            className="p-1.5 sm:p-2 text-slate-300 hover:text-white rounded-lg hover:bg-slate-800 transition-colors"
