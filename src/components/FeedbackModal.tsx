          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Debzane Concept Teleprompter feedback & feature requests
              </p>
            </div>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto py-3.5 space-y-4 pr-1">
          ...
          <form onSubmit={handleSubmit} className="p-4 bg-slate-950/90 border border-slate-800 rounded-2xl space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <input
                type="text"
                placeholder="Your Name (e.g. Samuel, Creator)"
                value={userName}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-2 pt-1">
              {submittedSuccess ? (
                ...
                <span className="text-[11px] text-slate-500">
                  Shared across the Debzane creator community.
                </span>
              )}
          ...
          <div className="space-y-2.5">
            ...
            {comments.map((c) => (
              <div key={c.id} className="p-3 bg-slate-950/60 border border-slate-800/80 rounded-2xl space-y-1.5">
                <div className="flex items-center justify-between">
